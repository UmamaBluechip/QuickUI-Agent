    ...
    <div>
      ...
      <nav className="bg-gray-800 p-4">
        <div className="container mx-auto flex items-center justify-center">
          {/* Company Logo */}
          <img src="/logo.jpeg" alt="Bluechip Technologies Asia" className="h-20 w-auto mr-2" />
          {/* Company Name */}
          <h1 className="text-white text-lg font-bold">Bluechip Technologies Asia</h1>
        </div>
      </nav>
      ...
      <div className="bg-blue-600 text-white text-center py-10">
        <div className="md:w-2/3 mx-auto">
          ...
          <button
            onClick={() => document.getElementById('ideaInput').focus()}
